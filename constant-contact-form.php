	...
	<div class="wrap">
		<div class="form-wrap">
			...
			{	
				...
				$ccf_username 			= stripslashes(sanitize_text_field($_POST['ccf_username']));
				$ccf_password 			= stripslashes(sanitize_text_field($_POST['ccf_password']));
				$ccf_group 				= stripslashes(sanitize_text_field($_POST['ccf_group']));		
				$ccf_title 				= stripslashes(sanitize_text_field($_POST['ccf_title']));
				$ccf_caption 			= stripslashes(sanitize_text_field($_POST['ccf_caption']));
				$ccf_adminemail 		= stripslashes(sanitize_text_field($_POST['ccf_adminemail']));
				$ccf_with_in_textbox 	= stripslashes(sanitize_text_field($_POST['ccf_with_in_textbox']));
				$ccf_button 			= stripslashes(sanitize_text_field($_POST['ccf_button']));
				$ccf_fromemail 			= stripslashes(sanitize_text_field($_POST['ccf_fromemail']));
				$ccf_adminmail 			= stripslashes(sanitize_text_field($_POST['ccf_adminmail']));
				$ccf_adminmail_subject 	= stripslashes(wp_filter_post_kses($_POST['ccf_adminmail_subject']));
				$ccf_adminmail_content 	= stripslashes(wp_filter_post_kses($_POST['ccf_adminmail_content']));
				$ccf_usermail 			= stripslashes(wp_filter_post_kses($_POST['ccf_usermail']));
				$ccf_usermail_subject 	= stripslashes(wp_filter_post_kses($_POST['ccf_usermail_subject']));
				$ccf_usermail_content 	= stripslashes(wp_filter_post_kses($_POST['ccf_usermail_content']));
				$ccf_homeurl 			= stripslashes(sanitize_text_field($_POST['ccf_homeurl']));
...
function ccf_add_javascript_files() 
{
	if (!is_admin())
	{
		wp_enqueue_script( 'ccf_ajax', plugins_url().'/constant-contact-form/class/ccf_ajax.js');
		wp_enqueue_style( 'ccf_custom', plugins_url().'/constant-contact-form/class/ccf_custom.css','','','screen');
	}
}    
